...
export const Disclaimer = () => {
  ...
  return (
    <div className="min-h-[100vh] bg-[#070707]">
      ...
      >
        <span className="text-[14px] mont-bold text-[#363636] h-[38px] w-[225px] flex items-center justify-center border-[1px] border-[#363636] rounded-full mb-[16px] md:text-[10px] md:w-[150px] md:h-[29px] pt-[4px]">
