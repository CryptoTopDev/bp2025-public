    ...
    <div className="min-h-[100vh] bg-[#070707] overflow-hidden relative">
      ...
      <div className="relative py-[62px] h-[660px] flex items-center lg:h-[unset] lg:flex-col md:pb-0">
        ...
        <div className="w-[1061px] mx-auto z-10 lg:w-full lg:px-4 lg:order-1 sm:!w-[330px] sm:mx-auto">
          <span className="text-[14px] mont-bold text-[#363636] h-[38px] w-[280px] flex items-center justify-center border-[1px] md:mx-auto border-[#363636] rounded-full mb-[16px] sm:text-[10px] sm:w-[189px]">
            Invest in Us. Empower Yourself.
          </span>
          <h1 className="text-[#fff] md:text-[42px] md:text-center md:leading-[40px] w-[743px] leading-[78px] text-[72px] mont-bold lg:w-full">
            Empowering the Black Community Through KYN
          </h1>
        </div>
      </div>
      <div className="w-[1061px] mx-auto py-[120px] grid grid-cols-[1fr_463px] gap-[60px] items-center z-10 relative lg:w-full lg:px-4 lg:grid-cols-1 md:py-[60px]">
      ...
      <div
        className=" w-[817px] mx-auto grid grid-cols-4 pb-[120px] lg:w-full 
      lg:pb-[60px] lg:pt-0"
      >
      ...
      <div className="relative pb-[120px] lg:px-4 lg:pb-[60px] ">
        <img
          src={hand}
          alt=""
        ...
        <div className="border-[1px] relative z-1 w-[1061px] mx-auto  h-[601px] border-[#B0B0B0] bg-gradient-to-tr from-[#0D0D0D] to-[#151515] rounded-[30px] mb-[120px] grid grid-cols-2 items-center lg:h-[586px] lg:grid-cols-1 lg:px-[42px] sm:!px-[20px] lg:py-[44px] lg:w-full lg:items-start lg:mb-10">
          ...
          <div className="w-[420px]">
            ...
            <ul className="my-[29px] flex flex-col gap-[16px] lg:gap-[5px] lg:my-[15px] lg:mb-[5px] sm:!gap-[10px]">
              <li className="text-[16px] mont-light text-[#fff] sm:flex sm:gap-4">
                <span className="mont-bold">Presale Start Date:</span> January
                20, 2025
              </li>
              <li className="text-[16px] mont-light text-[#fff]  sm:flex sm:gap-4">
                <span className="mont-bold">Presale End Date:</span> June 19,
                2025
              </li>
              <li className="text-[16px] mont-light text-[#fff]  sm:flex sm:gap-4">
                <span className="mont-bold">Presale Price:</span> $0.065 per KYN
                token
              </li>
                <li className="text-[16px] mont-light text-[#fff]  sm:flex sm:gap-4">
                <span className="mont-bold"> Whitelisted Presale Price:</span> $0.059 per KYN
                token
              </li>
              <li className="text-[16px] mont-light text-[#fff]  sm:flex sm:gap-4">
